# -*- coding: utf-8 -*-
"""
Created on Thu Sep  8 11:25:16 2016
...
ScoresBinnedAllTasks = pd.read_csv("ScoresBinnedAllTasksTyposCorrected.csv")
ScoresBinned  = ScoresBinnedAllTasks.set_index("Bin",drop = True)

#plt.figure(figsize=(11.69,8.27))
#ScoresBinnedAllTasks.plot(colormap = 'winter')
...
ax2 = ScoresBinned.plot(ax = ax1,colormap = 'winter', title = "Learning Curves Group 2",figsize = (11.69,8.27))
...
plt.savefig("ScoresBinnedPer100Trials.eps",format = "eps")
plt.savefig("ScoresBinnedPer100Trials.png",format = "png")
