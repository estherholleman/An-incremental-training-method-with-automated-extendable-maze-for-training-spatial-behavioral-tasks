...
days2 = sorted(range(1,23)*60)
days3 = sorted(range(1,8)*60)
days4 = sorted(range(1,13)*60)
days5 = sorted(range(1,8)*60)
days6 = sorted(range(1,10)*80)
days7 = sorted(range(1,7)*100)


days = days1 + days2 + days3 + days4 + days5 + days6 + days7
